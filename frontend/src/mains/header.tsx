...
import bGirlVideo from "../assets/waste_images/videos/istockphoto-1201411962-640_adpp_is.mp4"
    ...
    <>
        <header className={`relative w-[100vw] lg:min-h-[90vh] min-h-[430px] z-[10]`}>
          ...
          <nav className="flex items-stretch justify-between py-5 sm:px-[10%]  px-[10px] mb-5 font-medium">
            <h1 className={`sm:text-3xl text-2xl tracking-widest  ${bgImage === ladyVideo || bgImage === bGirlVideo?"text-theme": "text-white"} `}>GreenAge</h1>            
            {/* <Logo/> */}
