...
import * as allWasteHeaps from "../assets/waste_images/trash_heaps"
...
const allValues = Object.values(allWasteHeaps);
...
function loadImages(arg: Array<string>):JSX.Element[]{
  ...
  return (
    ...
    <section className='bg-[url("./assets/waste_images/problem-bg-img.jpg")] bg-[length:150px_150px] bg-contain p-10' id='problem-section'>
